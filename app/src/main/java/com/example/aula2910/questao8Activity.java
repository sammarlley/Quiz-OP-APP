...
public class questao8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_questao8);
        ...
        btn_avancar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ir = new Intent(getBaseContext(), questao9Activity.class);
                startActivities(ir);
            }
        });
    }
